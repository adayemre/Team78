...
public class RegistrantDBSteps {
    ...
    @Given("user sends the query to DB and gets column data {string} and {string}")
    public void user_sends_the_query_to_db_and_gets_column_data_and(String query, String columnName) {
